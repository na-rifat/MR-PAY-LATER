 ...
 * Plugin URI: https://rafalotech.com/plugins/wordpress/mr-pay-later
 * Description: Accepts later payment
 * Author: Rafalo tech
 * Author https://rafalotech.com
 * Version: 1.0.0
 * Text Domain: mrpay
...
function wc_offline_gateway_init() {
	...
	class MR_PAY_LATER extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->id                 = 'mrpaylater';
			$this->icon               = plugins_url('', __FILE__) . "/assets/img/ico.jpeg";
		...
		public function init_form_fields() {
			...
			$this->form_fields = apply_filters( 'wc_offline_form_fields', array(
				...
				'description' => array(
					...
					'default'     => __( 'You can pay later with this method.', 'mrpay' ),
					'desc_tip'    => true,
				),
